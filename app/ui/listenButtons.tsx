...
export default function ListenButtons() {
    return (
        <div className="flex flex-col md:flex-row md:justify-evenly w-[600px] mt-10">
            <a
                target="_blank"
            ...
            >
                <Image src={AppleLight} alt='Apple podcasts logo' className='mb-8 md:mx-8' />
            </a>
            <a
                target="_blank"
                ...
                className='flex items-center mb-2 md:mb-0'
            >
                <Image src={SpotifyLight} alt='Spotify logo' className='mb-8 md:mx-8' />
            </a>
            <a
                target="_blank"
                ...
                className='flex items-center mb-2 md:mb-0'
            >
                <Image src={AmazonLight} alt='Amazon Music logo' className='mb-8 md:mx-8' />
            </a>
        </div>
    );
}
